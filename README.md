...
src/
  components/     React components (islands) + Astro components
    ...
    NotificationsQueue.tsx      Contributor approval queue (renders any subject type)
  ...
  integration/    Integration tests (local Supabase required) — 162 tests across the pipeline
  tests/          Unit tests
supabase/
