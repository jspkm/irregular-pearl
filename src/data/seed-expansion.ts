...
export const expansionPieces: SeedPiece[] = [
  ...
  },
  {
    ...
    external_links: [
      ...
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=FpGOKBMRJeE', label: 'Helmut Walcha — organ recording' },
  ...
  },
  {
    ...
    external_links: [
      ...
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=ihYOkPdbCP4', label: 'Diane Bish — organ performance' },
  ...
  },
  {
    ...
    external_links: [
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=bL-S2JvPKig', label: 'Olivier Latry — Notre-Dame de Paris' },
  ...
  // ═══════════════════════════════════
  {
    ...
    external_links: [
      ...
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=ws0IBBaCSYs', label: 'Alban Berg Quartet — live performance' },
  ...
  },
  {
    ...
    external_links: [
      ...
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=otdayisyIAg', label: 'Belcea Quartet — complete performance' },
  ...
  },
  {
    ...
    external_links: [
      ...
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=ieRQyyPowH4', label: 'Quatuor Ébène — complete performance' },
  ...
  },
  {
    ...
    external_links: [
      ...
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=tLQspwKY08Y', label: 'Quatuor Ébène — complete performance' },
  ...
  },
  {
    ...
    external_links: [
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=WJMUDLpzjlA', label: 'Takács Quartet — complete performance' },
  ...
  // ═══════════════════════════════════
  {
    ...
    external_links: [
      ...
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=IVk9kqJuGGY', label: 'Beaux Arts Trio — complete performance' },
  ...
  },
  {
    ...
    external_links: [
      ...
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=k4r_k2GZ3Hw', label: 'Martha Argerich and friends — live' },
  ...
  // ═══════════════════════════════════
  {
    ...
    external_links: [
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=KP89VKQS7kg', label: 'Berlin Philharmonic — Karajan' },
  ...
  },
  {
    ...
    external_links: [
      ...
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=KhSiVflMZcI', label: 'Bernstein — New York Philharmonic' },
  ...
  // ═══════════════════════════════════
  {
    ...
    external_links: [
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=fUF8F8DJGXE', label: 'Xavier de Maistre — harp' },
  ...
  },
  {
    ...
    external_links: [
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=WVHiJLsO0NU', label: 'Yolanda Kondonassis — solo harp' },
  ...
  // ═══════════════════════════════════
  {
    ...
    external_links: [
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=yNMT2kR_yWY', label: 'Keiko Abe — live performance' },
  ...
  },
  {
    ...
    external_links: [
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=IjKJBDPJGiI', label: 'Ney Rosauro — live performance' },
  ...
  },
  {
    ...
    external_links: [
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=4q4t5TqLhkA', label: 'Jonathan Haas — solo timpani' },
  ...
  },
  {
    ...
    external_links: [
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=4X_kHcqO77Q', label: 'Solo snare drum performance' },
    ],
  },
  ...
  // ═══════════════════════════════════
  {
    ...
    external_links: [
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=S9FWR1cU7eo', label: 'Tabea Zimmermann — viola' },
  ...
  },
  {
    ...
    external_links: [
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=sLI3VYH4PA0', label: 'Yuri Bashmet — viola' },
  ...
  },
  {
    ...
    external_links: [
      ...
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=JFrj8Guu4O0', label: 'Sviatoslav Richter — historic recording' },
  ...
  // ═══════════════════════════════════
  {
    ...
    external_links: [
      ...
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=aG7S_0eVLyE', label: 'Dietrich Fischer-Dieskau — definitive recording' },
  ...
  },
  {
    ...
    external_links: [
      ...
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=d67ql-m_KhA', label: 'Fritz Wunderlich — legendary recording' },
  ...
  // ═══════════════════════════════════
  {
    ...
    external_links: [
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=wEW4K3jkqag', label: 'François Leleux — oboe' },
  ...
  },
  {
    ...
    external_links: [
      ...
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=KVY0QmgDKqE', label: 'Radek Baborák — horn' },
  ...
  },
  {
    ...
    external_links: [
      { type: 'youtube', url: 'https://www.youtube.com/watch?v=S3-2j5Fhb-o', label: 'Milan Turkovic — bassoon' },
